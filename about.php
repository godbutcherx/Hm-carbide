...
<head>
    ...
    <title>HM Carbide Swiss GmbH | About</title>
    ...
    <style>
        /* --- 1. GLOBAL STYLE (INDEX ILE AYNI) --- */
        :root { --primary: #1a252f; --secondary: #d93025; --light: #f8f9fa; --text: #333; --text-light: #777; }
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Montserrat', sans-serif; }
        body { background: var(--light); color: var(--text); line-height: 1.8; display: flex; flex-direction: column; min-height: 100vh; overflow-x: hidden; }
        ...
        .content-box { background: white; padding: 50px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border-top: 5px solid var(--secondary); }
        .content-box h3 { font-size: 1.8rem; color: var(--primary); margin-bottom: 25px; line-height: 1.3; font-weight: 800; }
        .content-box p { margin-bottom: 20px; text-align: justify; color: #555; font-size: 1.1rem; }
...
<body>
    ...
    <div class="page-header-section"><h1 class="page-title reveal" data-i18n="nav_about">ÜBER UNS</h1></div>
    <div class="container"><div id="contentArea" class="content-box reveal"></div></div>
